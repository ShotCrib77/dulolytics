...
export default function StatsPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen items-center justify-between font-sans bg-[#070b12]">
      ...
      {/* Main content */}
      <div className="flex flex-col flex-1 items-center justify-center gap-8 px-2 py-12 lg:py-16 w-full">
        <h1
          className="text-3xl md:text-4xl font-semibold tracking-wide text-[#c8aa6e]"
